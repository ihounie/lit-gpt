...
class LoRALinear(LoRALayer):
    ...
    def merge(self):
        ...
        raise NotImplementedError("(ihounie) weight merging tnot implemented")
...
class LoRAQKVLinear(LoRALinear):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            r: rank of the weight update matrices. To make sense of using LoRA the rank should be smaller than the rank of
                the weights of the model. The rank can be as low as 1: https://arxiv.org/pdf/2106.09685.pdf (section 7.2)
                #(ihounie) r is now the Tensor rank, not the matrix rank.
            lora_alpha: alpha is needed for scaling updates as alpha/ #TODO(ihounie): should we divide by r*h h is the number of heads, and r is the Tensor rank?
                "This scaling helps to reduce the need to retune hyperparameters when we vary r"
                https://arxiv.org/pdf/2106.09685.pdf (section 4.1)
            lora_dropout: dropout that is applied on the input in the LoRA branch (before multiplying by matrix A)
        ...
        #    raise NotImplementedError("(ihounie) Need to implement tensor LoRA for only one of QKV matrices")
    ...
    def merge(self):
        ...
        raise NotImplementedError("(ihounie)")
        # Let's assume that:
